...
import Public from "./svg/public.js";
...
const SharedPostComp = ({ postData }) => {
  const { onClickShare, snackMsg, setSnackMsg } = usePost(postData);
  ...
  const postUserId =
    postData?.sharedById != null ? postData?.sharedById : postData?.createdById;
          ...
          <div className={styles.post}>
            <div className={styles.postHeader}>
              <div
                ...
                onClick={() => onClickToGoToProfilePage(postData.sharedById)}
              >
                <Image
                  src={profilePic}
                  alt="profilePic"
              ...
              <div className={styles.dotHover}>
                <SaveEditDeleteMenu
                  userId={postData?.sharedById}
                  postUserId={user._id}
                />
              </div>
            </div>
            <div style={{ border: "solid #dadcdf 1px" }}>
              ...
              <div className={styles.postHeader}>
                <div
                  className={styles.postHeaderLeft}
                  onClick={() =>
                    onClickToGoToProfilePage(postData?.createdById)
                  }
                >
                  <Image
                    src={profilePic}
