...
import profilePicture from "../facebookPost/images/formatedImage/profilePic.png";
import postPicture from "../facebookPost/images/formatedImage/pollfishPeople.png";
  ...
  return (
    <div className="post">
      ...
      <div className={styles.post_actions}>
        ...
        <div
          className={styles.post_action && styles.dotHover }
        >
          <i className={styles.like_icon}></i>
          <span>Like</span>
        </div>
        <div className={styles.post_action && styles.dotHover }>
