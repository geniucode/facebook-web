...
import { feelings, images } from "./feelings.js";
import styles from "../../styles/facebookReactPostModal.module.css";
    ...
    <div>
      ...
      >
        <Box sx={style} className={styles.container}>
          <div className={styles.boxHeading} onClick={props.handleClose}>
